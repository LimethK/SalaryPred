...
st.markdown('<h1 style="color: blue; text-align: center;">Salary Prediction App</h1>', unsafe_allow_html=True)
st.markdown('<p style="color: red; text-align: center;">Enter the following details for prediction &#128071;</p>', unsafe_allow_html=True)
st.markdown('<p style="color: red; text-align: center;">For some options, please select the best answer suits you!</p>', unsafe_allow_html=True)
